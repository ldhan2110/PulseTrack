...
const mockTasks: Task[] = [
  {
    ...
    workflowStatus: { id: 'ws-backlog', projectId: 'proj-1', name: 'Backlog', key: 'BACKLOG', color: '#6b7280', position: 0, isDefault: true, isClosed: false, autoDateField: null, autoDateAction: null },
    storyPoints: 5,
    assigneeId: null,
    sprintId: null,
    projectId: 'proj-1',
  ...
  },
  {
    ...
    workflowStatus: { id: 'ws-in-progress', projectId: 'proj-1', name: 'In Progress', key: 'IN_PROGRESS', color: '#3b82f6', position: 1, isDefault: false, isClosed: false, autoDateField: null, autoDateAction: null },
    storyPoints: 3,
    assigneeId: null,
    sprintId: null,
    projectId: 'proj-1',
  ...
  },
  {
    ...
    workflowStatus: { id: 'ws-blocked', projectId: 'proj-1', name: 'Blocked', key: 'BLOCKED', color: '#ef4444', position: 4, isDefault: false, isClosed: false, autoDateField: null, autoDateAction: null },
    storyPoints: null,
    assigneeId: null,
    sprintId: null,
    projectId: 'proj-1',

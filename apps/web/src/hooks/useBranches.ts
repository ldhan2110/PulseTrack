...
export function useRemoteBranches(projectId: string, repositoryId: string) {
  return useQuery({
    queryKey: ['remoteBranches', projectId, repositoryId],
    queryFn: () => api.getRemoteBranches(projectId, repositoryId),

...
| 2. Project & Task Management | 9/10 | In Progress|  |
...
Plans:
- [ ] 08-01-PLAN.md — Schema migration (Attachment + TaskHistory), deps install, history recording in TasksService, history endpoint
